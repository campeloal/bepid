...
//    firstFrame.origin.x = 20;
//    firstFrame.origin.y = 20;
//    firstFrame.size.width -= 20;
//    firstFrame.size.height -= 20;
//    int width = firstFrame.size.width;
//    int height = firstFrame.size.height;
//    CGRect new = firstFrame;
//    new.size.width -= 20;
//    new.size.height -= 20;
//    TESView *firstView = [[TESView alloc] initWithFrame:new];
//    firstView.backgroundColor = [UIColor blueColor];
//    //firstView.layer.borderWidth = 20;
//    [self.window addSubview:firstView];
//    CGRect secondFrame = CGRectMake(width/2 - 25, height/2 - 35, 30, 50);
//    TESView *secondView = [[TESView alloc] initWithFrame:secondFrame];
