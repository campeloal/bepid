...
#import "ASCIndigoViewController.h"

@interface ASCIndigoViewController ()

@end

@implementation ASCIndigoViewController
...
- (void)viewDidLoad
{
    ...
    self.title =  @"View Controller Índigo 01";
