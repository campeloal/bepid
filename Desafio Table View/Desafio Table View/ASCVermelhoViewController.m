...
#import "ASCVermelhoViewController.h"

@interface ASCVermelhoViewController ()

@end

@implementation ASCVermelhoViewController
...
- (void)viewDidLoad
{
    ...
    self.title = @"View Controller Vermelho 01";
