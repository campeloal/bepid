...
#import "ASCVermelho2ViewController.h"

@interface ASCVermelho2ViewController ()

@end

@implementation ASCVermelho2ViewController
...
- (void)viewDidLoad
{
    ...
    self.title =  @"View Controller Vermelho 02";
