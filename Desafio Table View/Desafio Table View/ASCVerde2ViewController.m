...
#import "ASCVerde2ViewController.h"

@interface ASCVerde2ViewController ()

@end

@implementation ASCVerde2ViewController
...
- (void)viewDidLoad
{
    ...
    self.title = @"View Controller Verde 02";
    
    UIImage *image = [UIImage imageNamed:@"goias.jpg"];
