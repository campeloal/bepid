...
#import "ASCLaranjaViewController.h"

@interface ASCLaranjaViewController ()

@end

@implementation ASCLaranjaViewController
...
- (void)viewDidLoad
{
    ...
    self.title = @"View Controller Laranja 01";
